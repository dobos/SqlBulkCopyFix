...
namespace Microsoft.SqlServer.Server.Custom
{
    ...
    internal abstract class SmiTypedGetterSetter : ITypedGettersV3, ITypedSettersV3
    {
        ...
        public virtual bool IsDBNull(SmiEventSink sink, int ordinal)
        {
            if (!CanGet)
            {
                throw System.Data.Common.Custom.ADP.InternalError(System.Data.Common.Custom.ADP.InternalErrorCode.InvalidSmiCall);
            }
            else
            {
                throw System.Data.Common.Custom.ADP.InternalError(System.Data.Common.Custom.ADP.InternalErrorCode.UnimplementedSMIMethod);
            }
        }
