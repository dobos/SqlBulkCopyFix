...
using System.Data.SqlTypes.Custom;
...
using System.Xml;
using Res = System.Custom.SR;
#if MANAGED_SNI
using System.Data.SqlClient.SNI;
#endif

using MSS = Microsoft.SqlServer.Server.Custom;
...
namespace System.Data.SqlClient.Custom
{
    ...
    sealed internal class TdsParser
    {
        ...
        internal SqlError ProcessSNIError(TdsParserStateObject stateObj)
        {
            ...
            string sqlContextInfo = System.Custom.SR.GetResourceString(Enum.GetName(typeof(SniContext), stateObj.SniContext), Enum.GetName(typeof(SniContext), stateObj.SniContext));
            string providerRid = String.Format((IFormatProvider)null, "SNI_PN{0}", (int)sniError.provider);
            string providerName = System.Custom.SR.GetResourceString(providerRid, providerRid);
